...
Navne med små bogstaver er *steder*, som du kan gå til ved at skrive f.eks. `cd eventyr`. Du kan bruge kommandoen `ls` til at se dig omkring på et sted. Du vil se nye sted og ting du kan undersøge nærmere.
